...
impl SnowflakeIdGenerator {
    ...
    // 时间戳左移位数
    const TIMESTAMP_SHIFT: i64 = Self::SEQUENCE_BITS + Self::MACHINE_ID_BITS + Self::DATACENTER_ID_BITS;
...
/// Snowflake ID 桶 (线程安全版本)
/// 
/// 使用互斥锁保护内部生成器，可在多线程环境中安全使用
