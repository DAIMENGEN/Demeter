...
export const projectApi = {
  ...
  getAllProjects: (params?: Omit<ProjectQueryParams, "page" | "pageSize">) => {
    return httpClient.get<Project[]>("/projects/all", { params });
  },
  ...
  getProjectByName: (projectName: string) => {
    return httpClient.get<Project>(`/projects/name/${projectName}`);
  },
  ...
  batchDeleteProjects: (data: BatchDeleteParams) => {
    return httpClient.post("/projects/batch-delete", data);
  },
  ...
  getMyCreatedProjects: (params?: Omit<ProjectQueryParams, "page" | "pageSize">) => {
    return httpClient.get<Project[]>("/projects/my-created", { params });
  },
  ...
  getMyAccessibleProjects: (params?: Omit<ProjectQueryParams, "page" | "pageSize">) => {
    return httpClient.get<Project[]>("/projects/my-accessible", { params });
  },
  ...
  getRecentlyAccessedProjects: (limit?: number) => {
    return httpClient.get<Project[]>("/projects/recently-accessed", {
      params: { limit }
    });
  }
};
